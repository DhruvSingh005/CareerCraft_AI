<div align="center">
  <br />
    <a>
      <img src="public/readme/header_image.png" alt="Project Banner">
    </a>
  <br />
...
- **[Puter.js](https://puter.js.org/)** is a tiny client‑side SDK that adds serverless auth, storage, database, and AI (GPT, Claude, DALL·E, OCR…) straight into your browser app—no backend needed.
...
```bash
git clone [https://github.com/your-username/career-craft-ai.git]
cd career-craft-ai